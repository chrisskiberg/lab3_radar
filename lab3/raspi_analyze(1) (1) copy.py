...
# filename="bil_sno6_maal5"
sample_period, data = raspi_import('bil_sno5_maal3_2.bin')
...
"bil_sno5_maal1": [22000,140,310],
"bil_sno5_maal2": [22000,110,340],
...
t = np.linspace(start=0, stop=num_of_samples, num=num_of_samples)
data0=data[0:,0]
data1=data[0:,1]
